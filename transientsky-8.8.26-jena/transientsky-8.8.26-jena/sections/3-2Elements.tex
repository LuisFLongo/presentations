...
% ----- Right image -----
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{../fig/dd2_180_vlr_hr_constatm/DD2_q1.67_T_frame_120.png}
...
%\hspace{0.04\linewidth}%
\includegraphics[width=1.0\linewidth]{../fig/dd2_180_vlr_hr_constatm/DD2A_polar.pdf}

\column{0.4\textwidth}
\scriptsize
\begin{itemize}
	\item WinNet fed with datasets evolved for 150\,ms and 1\,s
