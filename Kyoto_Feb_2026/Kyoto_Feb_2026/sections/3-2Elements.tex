...
\begin{itemize}
	...
	\item Largest mass of heavy $r$-process elements for DD2\_q1.67
	\item SFHo\_q1.0 has the smallest production of H and He and light $r$-process elements
\end{itemize}
...
% ----- Left image -----
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{../fig/dd2_180_vlr_hr_constatm/DD2_q1.67_Lanthanides_frame_120.png}

% ----- Right image -----
\column{0.5\textwidth}
\includegraphics[width=\linewidth]{../fig/dd2_180_vlr_hr_constatm/DD2_q1.67_Actinides_frame_120.png}
...
\centering
% --- First row ---
\includegraphics[width=0.48\linewidth]{../fig/blh_vlr_hr_constatm/BLH_polar.pdf}%
\hspace{0.04\linewidth}%
\includegraphics[width=0.48\linewidth]{../fig/sfho_vlr_hr_constatm/SFHO_polar.pdf}

\vspace{2mm}

% --- Second row ---
\includegraphics[width=0.48\linewidth]{../fig/dd2_135_vlr_hr_constatm/DD2S_polar.pdf}%
\hspace{0.04\linewidth}%
\includegraphics[width=0.48\linewidth]{../fig/dd2_180_vlr_hr_constatm/DD2A_polar.pdf}
...
\centering
% --- First row ---
\includegraphics[width=0.45\linewidth]{../fig/blh_vlr_hr_constatm/Energy_evolution_zoom_BLH_q1.43_days.pdf}%
\hspace{0.04\linewidth}%
\includegraphics[width=0.45\linewidth]{../fig/sfho_vlr_hr_constatm/Energy_evolution_zoom_SFHO_q1.0_days.pdf}

\vspace{2mm}

% --- Second row ---
\includegraphics[width=0.45\linewidth]{../fig/dd2_135_vlr_hr_constatm/Energy_evolution_zoom_DD2_q1.0_days.pdf}%
\hspace{0.04\linewidth}%
\includegraphics[width=0.45\linewidth]{../fig/dd2_180_vlr_hr_constatm/Energy_evolution_zoom_DD2_q1.67_days.pdf}
